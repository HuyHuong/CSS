			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							Survey <small> <i
								class="ace-icon fa fa-angle-double-right"></i> Create new survey 
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
					...
					<div class="row">
						<div class="col-xs-10">
							...
							<div class="row">
								<div class="col-xs-12">
									<form class="form-horizontal" role="form" action="createSurvey"
										method="post">

										<%
											Connection con = DataAccess.getConnection();
											List<Question> questionsList = QuestionDao.getAllQuestion(con);
											List<Project> projectList = ProjectDao.getAllProject(con);
										%>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right"
												for="form-field-1"> Survey Name </label>

											<div class="col-sm-9">
												<input type="text" id="form-field-1"
													placeholder="Survey Name" class="col-xs-10 col-sm-5"
													name="surveyName" />
											</div>
										</div>
										<div class="form-group">
										...
										<div class="table-header">Question Content List</div>
													...
													<c:forEach items="<%=questionsList%>" var="question">
														<tr>
															<td class="center"><label class="pos-rel"> <input
																	type="checkbox" class="ace" name="question"
																	value="${question.id }" /> <span class="lbl"></span>
															</label></td>
															<td>${question.contentEN }</td>
															<td>${question.contentVN }</td>
															<td>${question.contentJP }</td>
															<td>${question.type }</td>
														</tr>
													</c:forEach>
												</tbody>
										...
										<div class="table-header">Assign</div>
										<div>
											<table id="dynamic-table"
												class="table table-striped table-bordered table-hover">
												<thead>
												...
												<tbody>
													<%
														for (Project project : projectList) {
															UserInformation userInfo = UserInformationDao.findUserInfo(con, project.getUserInfoId());
													%>
													<tr>
														<td class="center"><label class="pos-rel"> <input
																type="checkbox" class="ace" name="project"
																value="<%=project.getId()%>"> <span class="lbl"></span>
														</label></td>
														<td><%=project.getId()%></td>
														<td><%=project.getName()%></td>
														<td><%=userInfo.getFirstName()%> <%=userInfo.getLastName()%>
														</td>
														<td><%=userInfo.getEmail()%></td>
														<td><%=userInfo.getCompany()%></td>
