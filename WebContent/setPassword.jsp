			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							Customer <small> <i
								class="ace-icon fa fa-angle-double-right"></i> Set Password
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
							...
							<form class="form-horizontal" action="setPassword" method="post">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1-1"> Old Password </label>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1-1"> New Password </label>

									<div class="col-sm-9">
										<input type="password" id="password form-field-1-1"
